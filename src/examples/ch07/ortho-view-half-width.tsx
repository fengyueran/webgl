...
export const OrthoViewHalfWidth = () => {
  ...
  useEffect(() => {
    ...
    const nearFarNode = nearFarNodeRef.current;
    ...
    document.onkeydown = function (ev) {
      keydown(ev, gl, n, u_ProjMatrix, projMatrix, nearFarNode);
    };

    draw(gl, n, u_ProjMatrix, projMatrix, nearFarNode); // Draw the triangles
  }, []);

  return (
    <div>
      <Canvas ref={nodeRef} width="600px" height="600px" />
      <p ref={nearFarNodeRef}>The near and far values are displayed here.</p>
    </div>
  );
};
